...
- ColorPicker `remove()` static method inconsistency ([#2139](https://dev.azure.com/mscomdev/Moray/_git/Moray/pullrequest/2139))
...
- IE11 console error caused by polyfills and some components that were not emitting custom events properly ([#1900](https://mscomdev.visualstudio.com/Moray/_git/Moray/pullrequest/1900))
...
- Restructure Fractal site
  - Refactor of Carousels ([#1838](https://mscomdev.visualstudio.com/Moray/_git/Moray/pullrequest/1838))
    ...
    - `carousel` modifier classes changed on the element using class `carousel` to reflect new naming convention
      - `carousel-layered` changed to `carousel-sneak-peak`, used for Sneak Peak carousels
...
- Update dependencies ([#1814](https://dev.azure.com/mscomdev/Moray/_git/Moray/pullrequest/1814))
  - Update all outdated dependencies except for Bootstrap and `@frctl/handlebars`
...
- Update glyph sizes ([#1627](https://mscomdev.visualstudio.com/Moray/_git/Moray/pullrequest/1627))
  ...
  - Glyph Updates
    ...
    - Change Tabs icons sizes (HTML, CSS)
...
- Outer `<div class="row">` in Tab List & Tab Panel ([#1665](https://mscomdev.visualstudio.com/Moray/_git/Moray/pullrequest/1665))
...
- Buy Box DB6 Microsoft 365 Updates ([#1630](https://mscomdev.visualstudio.com/Moray/_git/Moray/pullrequest/1630))
...
- Fix Buy Box DB6 ([#1570](https://mscomdev.visualstudio.com/Moray/_git/Moray/pullrequest/1570))
  ...
  - Fix button width on Office 365 live variants
...
- Add support page to Fractal and rename "Notes" tab to "Usage" ([#1420](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1420))
...
- Fix Spinner HCM visibility ([#1415](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1415))
  ...
  - Add alternate styles for `prefers-reduced-motion` media-query
...
- Fix Product Placement Game image size in viewport 1 from 221x231 to 222x331 ([#1317](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1317))
- Fix casing of `htmlTag` and `customDisplayText` for heading component and components that reference heading component ([#1291](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1291))
- Color Theming: Light or Dark Theme ([#1283](https://mscomdev.visualstudio.com/Moray/_git/Moray/pullrequest/1283))
  - Alert (fractal documentation only)
    - Remove multiple alert theme modifier classes on an alert which caused a styling rendering issue; alerts should only ever have one theme color modifier class.
  - CTA (fractal documentation only)
    - Remove light and dark examples using background color utilities, alternate colors will be represented under utilities
    - Clean up template so only the code for CTA is represented
  - Popover and Tooltip (fractal documentation only)
    - Disable example uses secondary color like all other examples to imply that the color _should not_ change if the popover is disabled
  - Progress (fractal documentation only)
    - Hide "alternate colors" variant from documentation (not to be used)

## [0.0.13] - 2020-01-17

### Changed

- Add Image Gallery to Fractal ([#1281](https://mscomdev.visualstudio.com/Moray/_git/Moray/pullrequest/1281))
  - Change Modal template to allow for excluding its footer
  - Add image gallery examples and documentation
- Sneak peek carousel ([#1213](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1213))
  - Area heading
    - Add centered option
    - Includes the grid `.row` in the HTML
  - Carousel
    - Change order of HTML elements (controls should come before slides)
    - Change recommended screen reader text on control buttons
  - Carousel hero
    - Require the `.carousel-layered` class in addition to `.carousel-hero`
    - Require the `.depth-lg-8` class in addition to `.depth-4.depth-md-none` for slides
  - Add Carousel sneak peek (WIP)
- Update prepend and append glyph references ([#1267](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1267))
  - Alert: update `glyph-prepend-success` to be `glyph-prepend-accept`
  - Star Rating & Product placement: update `glyph-append-star-fill` to be `glyph-append-favorite-star-fill`
  - Star Rating & Product placement: update `glyph-append-half-star-left` to be `glyph-append-outline-half-star-left`
  - Star Rating & Product placement: update `glyph-append-star` to be `glyph-append-favorite-star`
  - Video, hero(multi), mosaic tiles: update `glyph-prepend-play-circle` to be `glyph-prepend-play-button`
  - Video, hero(multi), mosaic tiles: update `glyph-prepend-play-outline` to be `glyph-prepend-play`
- Update Glyph and documentation ([#1263](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1263))
  - Update MWFMDL2 font files w/ newer version
  - Update glyphs.config.json, and variables.scss to reflect the new glyphs set
  - Update carousel.scss, close.scss, color-picker.scss, form-check.scss files content properties with newly-documented glyph names
- Update Ratings bar for accessibility ([#1272](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1272))
- Update gulpfile and JS dependencies to speed up fractal compilation ([#1279](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/2422))
- Buy box batch 2 ([#1246](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1246))
  - Update Color picker to allow optional image element
  - Update variant display name format in fractal; Add PB# before variant name
  - Reduce margin-bottom of product price
  - Change markup for buy box promotions to use h2 tags instead of strong tags

### Added

- Buy box batch 2 ([#1246](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1246))
  - Partial buy-box file directory to templates/buy-box
    - Shared buy-box.config for fractal handle
    - Shared buy-box.hbs template that all variants reference
  - Variant-specific config.json and documentation for:
    - badge-and-color-picker
    - badge-and-color-strikethrough
    - configs
    - simple-metadata
    - special-pricing-and-gallery
  - Text for number of images to buy box image gallery modal body
  - Title and aria-labelledby-id properties in json config to image gallery modal.
  - Partial block for image gallery modal

### Fixed

- Buy box batch 2 ([#1246](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1246))
  - Remove wrapping badge object for configs with badge JSON for variants with badges
  - Increase width of buy-box for vp3
  - Fix color picker label rtl placement
  - Fix Alt text with values of "No data available"

### Removed

- Buy box batch 2 picture markup for image galleries ([#1246](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1246))

## [0.0.12] - 2020-01-06

### Changed

- Update Documentation and Fractal templates ([#1251](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1251))
  - Pricing
  - Feature
  - Ratings bar (WIP)
  - Highlight specs, including a CSS class change from `pl-md-3` to `pl-md-2` in the large image variants
- Update Show more show less JS and documentation ([#1214](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1214))
- Add required classes `px-0 px-lg-g` to Regular hero grid column element ([#1248](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1248))
...
- Spinner (Ready)
  - Add component ([#1198](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1198))
  - Update HTML attributes and structure for accessibility ([#1209](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1209))
- Ratings bar (WIP) ([#1169](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1169))
- Sticky (WIP) ([#1172](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1172))
- Horizontal tabs (WIP) ([#1195](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1195))
- Highlight specs (WIP) ([#1157](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1157))
- Pricing (WIP) ([#1132](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1132))
- Feature (WIP) ([#1170](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1170))
- Autocomplete (WIP) ([#1117](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1117))

### Changed

- Standardize Fractal config, templates, and references for the following components ([#1216](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1216)):
  - Link group
  - Call to action
    - Button
  - Replace outdated button markup (`hover-darken` and `bg-primary`) in components with the reference to the Fractal button component
  - Update Highlight feature template to reflect current Fractal guidelines
- Add required class `h-100` to fix Multi Hero IE 11 issue ([#1230](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1230))
- Change Multi Hero VP2 image size ([#1210](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1210))
- Add Multi Hero data attribute to small placement card ([#1204](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1204))
- Add FAQ to Fractal and update to use Accordion HTML structure (change from `<div>` to `<ul>`) ([#1207](https://mscomdev.visualstudio.com/_git/Moray/pullrequest/1207))
...
- Mosaic (WIP)
- Add new glyphs
- Fractal contribution documentation
...
- Remove padding on video play glyph
- Remove extra border on badge
- RTL issue with .img-{breakpoint}-fill class
- Standardize glyph font sizes
- Remove VFI from non-interactive elements in IE11
...
- Remove relative paths from Bootstrap Sass imports
...
- Highlight specs
- Area heading
- Product placement - apps and devices (WIP)
- Carousel hero (WIP)

### Changed

- Update button styles and add additional button modifier classes
- Star ratings
- Alerts
- Video
...
- Color picker
- Video
- Implement new Fractal site
- Star rating filter

### Changed

- Add half star to star ratings
- Star ratings markup
- Quick links markup
- Update glyphs to new thick version
- Expand/collapse
...
- More glyphs in alerts
- Feature pattern
- FAQ pattern
- Quick links pattern
- Image component
- Pricing with strikethrough pattern
...
- Global VFI
- Autocomplete guidance for form elements
- Carousel controls
- Core blue for better color contrast
- Thicker chevron glyphs
- Responsive typography

### Fixed

- Accessible link colors in alerts
- Hover color of links styled like buttons

## [0.0.1] - 2019-07-16

- Initial release

[unreleased]: https://mscomdev.visualstudio.com/_git/Moray/branches?baseVersion=GTv1.10.0&targetVersion=GBrelease&_a=commits
[1.10.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.10.0
[1.9.2]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.9.2
[1.9.1]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.9.1
[1.9.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.9.0
[1.8.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.8.0
[1.7.1]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.7.1
[1.7.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.7.0
[1.6.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.6.0
[1.5.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.5.0
[1.4.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.4.0
[1.3.1]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.3.1
[1.3.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.3.0
[1.2.2]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.2.2
[1.2.1]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.2.1
[1.2.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.2.0
[1.1.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.1.0
[1.0.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv1.0.0
[0.9.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.9.0
[0.8.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.8.0
[0.7.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.7.0
[0.6.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.6.0
[0.5.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.5.0
[0.4.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.4.0
[0.3.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.3.0
[0.2.1]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.2.1
[0.2.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.2.0
[0.1.0]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.1.0
[0.0.14]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.14
[0.0.13]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.13
[0.0.12]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.12
[0.0.11]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.11
[0.0.10]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.10
[0.0.9]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.9
[0.0.8]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.8
[0.0.7]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.7
[0.0.6]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.6
[0.0.5]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.5
[0.0.4]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.4
[0.0.3]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.3
[0.0.2]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.2
[0.0.1]: https://mscomdev.visualstudio.com/_git/Moray?version=GTv0.0.1
