  ...
  return {
    ...
    */
    ...
    compareOr: (val1, val2, val3, val4, opts) => {
      return (val1 === val2 || val3 === val4) ? opts.fn(opts.data.root) : opts.inverse(opts.data.root);
    },
    ...
    uid: () => {
      ...
      return `mwf${crypto.randomBytes(4).toString('hex')}`;
    },
    /**
    ...
    */
    tokenConcat: (...args) => {
      return args.slice(0, -1).join(' ').trim();
    },
    /**
