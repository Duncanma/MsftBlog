...
class TouchUtil {
  ...
  removeEventListeners() {
    if (this.touchSupported) {
      if (this.pointerEvent) {
        this.el.removeEventListener(EventName.POINTER_DOWN, _swipeStart.bind(this));
        this.el.removeEventListener(EventName.POINTER_UP, _swipeEnd.bind(this));

        this.el.classList.remove(this.pointerEventClassName);
      } else {
        this.el.removeEventListener(EventName.TOUCH_START, _swipeStart.bind(this));
        this.el.removeEventListener(EventName.TOUCH_MOVE, _swipeMove.bind(this));
        this.el.removeEventListener(EventName.TOUCH_END, _swipeEnd.bind(this));
      }
    }
  }
}
