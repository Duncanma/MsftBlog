...
<body>
  ...
  <main {{{htmlAttr _target.context.meta.main.attributes}}}>
    {{!-- `meta` is a custom object that can be supplied in component configs --}}
    <div class="mwf-example-wrapper {{#unless _target.meta.wrapper.no-margin}}my-4{{/unless}} {{_target.meta.wrapper.classes}}">
      {{{ yield }}}
    </div>
  </main>
