...
function _valueChanged() {
  if (!this.value || this.el.value !== this.value) {
    ...
    this[EventName.ON_CHANGE] = new CustomEvent(EventName.ON_CHANGE, { bubbles: true, detail: { value: this.el.value } });
...
class Range {
  ...
  constructor(opts) {
    ...
    this.valueTextEvents = {
      changeEvent: { el: this.el, type: EventName.CHANGE, handler: _valueChanged.bind(this) },
      pointerEvent: { el: this.el, type: EventName.POINTERMOVE, handler: throttle(250, _valueChanged.bind(this)) }
    };
