...
customEvents[EventName.ON_STUCK] = new CustomEvent(EventName.ON_STUCK, { bubbles: true, cancelable: true });
customEvents[EventName.ON_UNSTUCK] = new CustomEvent(EventName.ON_UNSTUCK, { bubbles: true, cancelable: true });
  ...
  this.observer = new IntersectionObserver(entries => {
    ...
    if (this.enableObserver) {
      ...
      if (typeof prevState !== 'undefined' && prevState !== this.isStuck) {
        if (this.isStuck) {
          this.el.dispatchEvent(customEvents[EventName.ON_STUCK]);
        } else {
          this.el.dispatchEvent(customEvents[EventName.ON_UNSTUCK]);
        }
      }
