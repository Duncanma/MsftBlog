...
class ContentSwap {
  ...
  hide(element) {
    ...
    // Create and dispatch custom event
    this[EventName.ON_HIDE] = new CustomEvent(EventName.ON_HIDE, { bubbles: true });
  ...
  show(element) {
    ...
    // Create and dispatch custom event
    this[EventName.ON_SHOW] = new CustomEvent(EventName.ON_SHOW, { bubbles: true });
  ...
  swapContent() {
    ...
    if (this[EventName.ON_SWAP].defaultPrevented) {
      return;
    }
